...
<div class="pb-3">
    <a href="../../index.php" class="btn btn-primary"><i class="fa-solid fa-rotate-left"></i></a>
    <a href="edit.php?cod_estudiante=<?= $date[0]?>" class="btn btn-success"><i class="fa-solid fa-file-pen"></i></a>
