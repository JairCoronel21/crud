<?php
   ...
   class alumnoController {
         ...
         public function __construct(){
             require_once("C://xampp/htdocs/crud_coronel/model/alumnoModel.php");
         ...
         public function guardar($cod_estudiante, $dni, $nombres, $apellidos){
             ...
             return ($cod_estudiante!=false) ? header("Location:../../index.php") : header("Location:../../index.php");   
         }
         ...
         public function update($cod_estudiante, $dni, $nombres, $apellidos) {
             return ($this->model->update($cod_estudiante, $dni, $nombres, $apellidos) != false) ? header("Location:../../index.php"): header("Location:alumno.php");
         }

         public function delete($cod_estudiante){
             return ($this->model->delete($cod_estudiante)) ? header("Location:../../index.php") :  header("Location:show.php?cod_estudiante=".$cod_estudiante);
         }
   }
